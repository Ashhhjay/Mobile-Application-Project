    ...
    <View style={styles.container}>
      ...
      <View style={styles.outerCard}>
        <View style={styles.innerCard}>
          <Text style={styles.header1}>MESSAGES</Text>
          <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('Searchbyusername')}>
            <Text style={styles.buttonText}>Find by username</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('ByTeams')}> 
             <Text style={styles.buttonText}>Search in My Teams</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('ByContacts')}>
            <Text style={styles.buttonText}>Search in My Contacts</Text>
          </TouchableOpacity>
        </View>
      </View>
