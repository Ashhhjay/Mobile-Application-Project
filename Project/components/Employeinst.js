        ...
        <View style={styles.innerCard}>
          ...
          <View style={styles.row}>
            ...
            <View style={styles.inputContainer}>
              <Text style={styles.inputTitle}>Employe Instructions</Text>
            </View>
          </View>
          ...
          <TextInput 
            style={styles.input} 
            placeholder=" This job required these things (eg., laptops etc))" 
            placeholderTextColor="#888"
            multiline={true}
          />
          <View style={styles.header4}>
            <Text style={styles.title2}>(Max. 200 characters)</Text>
          </View>
           <View style={styles.container2}>
              <Text style={styles.header2}>Guidance Tips</Text>
              <View style={styles.bulletContainer}>
                <View style={styles.bulletPoint}></View>
                <Text style={styles.bulletText}>Provide onboarding instructions.</Text>
              </View>
              <View style={styles.bulletContainer}>
                <View style={styles.bulletPoint}></View>
                <Text style={styles.bulletText}>Highlight company policies.</Text>
              </View>
          </View>
